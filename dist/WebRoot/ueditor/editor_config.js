...
(function () {
    ...
    URL = window.UEDITOR_HOME_URL||"/ueditor/";//tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/file_uploadFile.action"//URL+"jsp/imageUp.jsp"             //图片上传提交地址
       ...
       ,imageFieldName:"file"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,snapscreenServerUrl: "/file_uploadFile.action"//URL +"jsp/imageUp.jsp" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/jsp/snapImgUp.jsp"”
        ,snapscreenPath: URL + "jsp/"
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:"/file_uploadFile.action"//URL + "jsp/imageUp.jsp"             //word转存提交地址
