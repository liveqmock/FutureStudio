package cn.future.pay.service.alipay.impl;
...
import cn.future.pay.util.AlipayUtil;
import cn.future.util.MD5Util;


public class AlipayRequestServiceImpl {
	/**
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.signType.equals("MD5") ) {
        	mysign = MD5Util.sign(prestr, AlipayConfig.key, AlipayConfig.charset);
        }
        return mysign;
    }
